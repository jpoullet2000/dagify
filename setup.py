...
from dagify import __version__ as version
...
setup_args = dict(
    name='dagify',
    version=version,
    description="Your scikit learn pipeline in simple text file",
    long_description=readme + '\n\n' + history,
    author="Jean-Baptiste Poullet",
    author_email='jeanbaptistepoullet@gmail.com',
    url='https://github.com/jpoullet2000/dagify',
    packages=find_packages(include=['dagify']),
